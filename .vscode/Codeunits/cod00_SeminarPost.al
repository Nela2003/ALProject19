...
codeunit 50100 "CSD Seminar-Post"
{
 ...
 SourceCodeSetup.Get;
 SourceCode := SourceCodeSetup."CSD Seminar";//ishte Seminar
 ...
 PstdSeminarRegHeader."No."));
  CopyCommentLines(
 SeminarCommentLine."Table Name"::"Seminar Registration Header", SeminarCommentLine."Table Name"::"Posted Seminar Reg. Header", "No.",PstdSeminarRegHeader."No.");
